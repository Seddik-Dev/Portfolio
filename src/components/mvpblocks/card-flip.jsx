...
export default function CardFlip({
  ...
  description = "I'm a full stack web developer with a passion for building web applications and mobile applications.",
  features = [],
  frontContent,
  frontImage,
  frontImageAlt = "Seddik Zaker",
}) {
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          {frontContent ? (
            <div className="absolute inset-0">{frontContent}</div>
          ) : frontImage ? (
          ...
          <div className="absolute right-0 bottom-0 left-0 p-5">
            <div className="flex items-center justify-between gap-3">
              <div className="space-y-1.5">
                ...
                <p className="line-clamp-2 text-sm tracking-tight text-white transition-all delay-[50ms] duration-500 ease-out group-hover:translate-y-[-4px] dark:text-zinc-300">
                  {subtitle}
                </p>
              </div>
